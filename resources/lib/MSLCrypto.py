...
class MSLCrypto():
  ...
  def fromDict(self, msl_data):
    self.kodi_helper.log(msg='Load RSA Keys')
  ...
  def __parse_handshake_result(self, headerdata):
    # Init Decryption
  ...
  def decrypt(self, keyId, iv, data):
    ...
    return cipher.decrypt(base64.standard_b64decode(data))
